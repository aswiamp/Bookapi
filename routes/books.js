...
router
  .route("/")
  .post(authorizePermissions("admin"), validationMiddleware, createBook)
  .get(getAllBooks);

router
  .route("/:id")
  .get(getBook)
  .delete(authorizePermissions("admin"), deleteBook)
  .patch(authorizePermissions("admin"), updateBook);
